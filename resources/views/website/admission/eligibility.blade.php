...
@section('content')
    ...
    <section class="pt-32 pb-20" style="background: linear-gradient(135deg, #047857 0%, #065f46 50%, #064e3b 100%);">
        <div class="container mx-auto px-4 text-center text-white">
            <h1 class="text-4xl md:text-5xl font-bold mb-4" data-aos="fade-up">ভর্তির যোগ্যতা</h1>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="flex items-start gap-3 bg-white rounded-xl p-4">
                            <div
                                ...
                                ✓</div>
                            <span>জন্ম নিবন্ধন সনদের সত্যায়িত কপি</span>
                        </div>
                        <div class="flex items-start gap-3 bg-white rounded-xl p-4">
                            <div
                                class="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="flex items-start gap-3 bg-white rounded-xl p-4">
                            <div
                                class="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0">
                                ✓</div>
                            <span>অভিভাবকের NID কপি</span>
                        </div>
                        <div class="flex items-start gap-3 bg-white rounded-xl p-4">
                            <div
                                class="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0">
                                ✓</div>
                            <span>পূর্ববর্তী প্রতিষ্ঠানের ছাড়পত্র (প্রযোজ্য ক্ষেত্রে)</span>
                        </div>
                        <div class="flex items-start gap-3 bg-white rounded-xl p-4">
                            <div
                                class="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0">
                                ✓</div>
                            <span>সর্বশেষ পরীক্ষার ফলাফলের কপি</span>
                        </div>
                        <div class="flex items-start gap-3 bg-white rounded-xl p-4">
                            <div
                                class="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0">
                                ✓</div>
                            <span>স্বাস্থ্য সনদ (প্রযোজ্য ক্ষেত্রে)</span>
                        </div>
                    </div>
                </div>
                    ...
                    @php
                        $departments = [
                            [
                                ...
                                'age' => '৫-১০ বছর',
                                'requirements' => [
                                    'ছাত্রের বয়স ৫-১০ বছরের মধ্যে হতে হবে',
                                    'কোনো পূর্ব শিক্ষাগত যোগ্যতা প্রয়োজন নেই',
                                    'প্রাথমিক বাংলা পড়ার ক্ষমতা থাকলে ভালো',
                                    'অভিভাবকের সাথে সাক্ষাৎকার প্রয়োজন',
                                ],
                            ],
                            [
                                'name' => 'হিফজ বিভাগ',
                                ...
                                'age' => '৭-১২ বছর',
                                'requirements' => [
                                    'ছাত্রের বয়স ৭-১২ বছরের মধ্যে হতে হবে',
                                    'নাজেরা সম্পন্ন বা আমপারা মুখস্থ থাকতে হবে',
                                    'মেধা ও স্মৃতিশক্তি পরীক্ষায় উত্তীর্ণ হতে হবে',
                                    'আবাসিক থাকার সুবিধা থাকলে উত্তম',
                                    'অভিভাবকের প্রতিশ্রুতি পত্র প্রয়োজন',
                                ],
                            ],
                            [
                                'name' => 'কিতাব বিভাগ',
                                ...
                                'age' => '১০-১৫ বছর',
                                'requirements' => [
                                    'ছাত্রের বয়স ১০-১৫ বছরের মধ্যে হতে হবে',
                                    'প্রাথমিক শিক্ষা সম্পন্ন (৫ম শ্রেণী পাস)',
                                    'আরবী ভাষার প্রাথমিক জ্ঞান থাকলে ভালো',
                            ...
                            [
                                ...
                                'requirements' => [
                                    ...
                                    'ন্যূনতম GPA ২.০০ প্রয়োজন',
                                    'বাংলাদেশ মাদরাসা শিক্ষা বোর্ড অনুমোদিত সনদ',
                                    'চারিত্রিক সনদ প্রয়োজন',
                                ],
                            ],
                            [
                                'name' => 'ফাযিল (ডিগ্রী)',
                                ...
                                'age' => '১৮+ বছর',
                                'requirements' => [
                                    'আলিম পরীক্ষায় উত্তীর্ণ হতে হবে',
                                    'ন্যূনতম GPA ২.০০ প্রয়োজন',
                                    'বাংলাদেশ মাদরাসা শিক্ষা বোর্ড অনুমোদিত সনদ',
                                    'ইসলামিক বিশ্ববিদ্যালয় অধিভুক্তি অনুযায়ী',
                                ],
                            ],
                        ];

...
@section('content')
    <section style="background: linear-gradient(135deg, #047857 0%, #065f46 50%, #064e3b 100%);" class=" pt-32 pb-20">
        <div class="container mx-auto px-4 text-center text-white">
            <h1 class="text-4xl md:text-5xl font-bold mb-4" data-aos="fade-up">প্রতিষ্ঠানের ইতিহাস</h1>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto prose prose-lg" data-aos="fade-up">
                ...
                <p class="text-gray-600 leading-relaxed">
                    ...
                    এখানে হাজার হাজার ছাত্র কুরআন হিফজ করে হাফেজে কুরআন হয়েছে এবং অনেকেই দ্বীনি শিক্ষায় সর্বোচ্চ ডিগ্রি
                    অর্জন করেছে।
                </p>
                <p class="text-gray-600 leading-relaxed">
                    আল্লাহর রহমতে প্রতিষ্ঠানটি দিন দিন উন্নতির দিকে এগিয়ে যাচ্ছে।
                    বর্তমানে এখানে শত শত ছাত্র অধ্যয়নরত এবং দক্ষ শিক্ষকমণ্ডলী তাদের শিক্ষাদান করছেন।
                </p>
            </div>
        </div>
    </section>
